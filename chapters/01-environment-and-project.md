...
| **任何平台** | 版本管理工具 | `go install golang.org/dl/go1.26.3@latest` |
...
> **版本策略**：教材文字以 Go 1.26.3 為基準；本 repo 內部分可執行範例仍可能保留 `go 1.22`，用來維持舊 toolchain 的學習相容性。新專案建議使用當前支援中的最新 Go patch release。
