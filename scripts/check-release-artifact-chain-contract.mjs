...
const expectedVersion = "v1.0.79";
const artifactTimestamp = "2026-07-05-060340";
...
const required = {
  ...
  "CHANGELOG.md": [
    ...
    "scripts/check-platform-promotion-policy-contract.mjs",
  ],
  "production-api-worker/README.md": [
