...
> 教材版本：`v1.0.31`
> 教材基準：`Go 1.26.3`
> 這次更新重點：補上 Prometheus scrape config、Compose monitoring profile、OpenAPI contract 與可重跑檢查，讓 operational runbook 與 API 合約都能從文件走到可驗證交付物。
