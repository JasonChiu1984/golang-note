...
> 教材版本：`v1.0.41`
> 教材基準：`Go 1.26.3`
> 這次更新重點：正式發布 API security contract gate，讓 `API_KEY`、Bearer token、公開 health probes、安全標頭、OpenAPI、Go tests 與 CI 靜態檢查固定。
