...
| Contract gate inventory | `node scripts/check-contract-gate-inventory-contract.mjs` 必須固定 30 個 root contract checker 都被 GitHub Actions 呼叫，且 Makefile、README、API contract、章節與整合視覺課程入口一致 |
